                ...
                {cartItems.length === 0 ? (
                    ...
                    <>
                        <div className={cartdrawer.cartContent}>
                            {cartItems.map((item) => (
                                <div key={item.id} className={cartdrawer.cartItem}>
                                    ...
                                    <div className={cartdrawer.itemDetails}>
                                        ...
                                        <p className={cartdrawer.itemPrice}>$ {(item.price * item.quantity).toFixed(2)}</p>
                                    </div>
                                    <button className={cartdrawer.removeBtn} onClick={() => removeFromCart(item.id)}>✕</button>
                                </div>
                            ))}
                        </div>
